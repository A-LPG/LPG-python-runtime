...
class ConfigurationStack(object):
    ...
    def makeStateList(self, parent: StateElement, stack: list, index: int, stack_top: int) -> StateElement:
        i: int = index
        while i <= stack_top:
    ...
    def findOrInsertStack(self, root: StateElement, stack: list, index: int, stack_top: int) -> StateElement:
    ...
    def push(self, stack: list, stack_top: int, conflict_index: int, curtok: int, action_length: int) -> None:
