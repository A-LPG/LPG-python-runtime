...
class ParseErrorCodes(object):
    ...
    errorMsgText: list = [
        ...
        "parsing terminated at self token",  # $NON-NLS-1$
        " inserted before self token",  # $NON-NLS-1$
        " expected after self token",  # $NON-NLS-1$
        "unexpected input discarded",  # $NON-NLS-1$
        " expected instead of self input",  # $NON-NLS-1$
        ...
        " reached after self token",  # $NON-NLS-1$
