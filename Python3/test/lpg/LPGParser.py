...
class LPGParser(RuleAction):
    ...
    prsTable  : ParseTable=  LPGParserprs()
    ...
    def __init__(self, lexStream: ILexStream = None):
        ...
        self.unimplementedSymbolsWarning : bool = False
        self.initRuleAction()
        try:
...
class IRootForLPGParser(object):
        ...
        __slots__ = ()
        def  getLeftIToken(self) -> IToken : raise TypeError('Can not instantiate abstract class  with abstract methods')
        def  getRightIToken(self) -> IToken : raise TypeError('Can not instantiate abstract class  with abstract methods')

        def  accept(self, v: IAstVisitor ):pass
...
class ASTNode(IAst):
        ...
        def getNextAst(self) -> IAst : return None
        def  setParent(self, parent : IAst ) :   self.parent = parent
        def  getParent(self) -> IAst : return self.parent

        def getLeftIToken(self) -> IToken:  return self.leftIToken
        def getRightIToken(self)-> IToken:  return self.rightIToken
        ...
        def __init__(self,leftIToken : IToken , rightIToken : IToken = None ):
         ...
         */'''
        def   getAllChildren(self) -> ArrayList : raise TypeError('Can not instantiate abstract class  with abstract methods')
...
class AbstractASTNodeList ( ASTNode , IAbstractArrayList):
        ...
        def size(self) -> int : return self._content.size()
        def getList(self) -> ArrayList:return self._content
        def  getElementAt(self,i : int) : return self._content.get( i if self.left_recursive else  self._content.size() - 1 - i)
        def  getArrayList(self) -> ArrayList :
         ...
         *
         */'''
        def  add(self, element : ASTNode) -> bool :
        
            self.addElement(element)
            return True
        

        def  addElement(self,element : ASTNode) : 
        ...
        def __init__(self,leftToken : IToken, rightToken : IToken , left_recursive : bool):        
              super().__init__(leftToken, rightToken)
...
class ASTNodeToken ( ASTNode, IASTNodeToken):
        ...
        def __init__(self,token : IToken ) : super().__init__(token)
        def  getIToken(self) ->IToken : return self.leftIToken
        def  toString(self) -> str :  return self.leftIToken.toString()

        '''/**
         * A token class has no children. So, we return the empty list.
         */'''
        def  getAllChildren(self) -> ArrayList :  return ArrayList()


        def  accept(self, v: IAstVisitor ) : 
...
class LPG ( ASTNode ,ILPG):
        ...
        def getEnvironment(self) ->LPGParser: return self.environment
        ...
        def __init__(self, environment : LPGParser,leftIToken : IToken , rightIToken : IToken ,
                             _options_segment,
                             _LPG_INPUT):
            ...
            self._options_segment : option_specList = _options_segment
            _options_segment.setParent(self)
            self._LPG_INPUT : LPG_itemList = _LPG_INPUT
...
class LPG_itemList ( AbstractASTNodeList, ILPG_INPUT):
        ...
        def  getLPG_itemAt(self, i :  int): return  self.getElementAt(i)

        __slots__ = ()
        def __init__(self,leftToken : IToken, rightToken : IToken , left_recursive : bool ):
        
            super().__init__(leftToken, rightToken, left_recursive)
        

        @staticmethod
        def LPG_itemListfromElement(element,left_recursive : bool )  :
...
class AliasSeg ( ASTNode ,ILPG_item):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
                             _alias_segment):
        
            super().__init__(leftIToken, rightIToken)

            self._alias_segment : aliasSpecList = _alias_segment
...
class AstSeg ( ASTNode ,ILPG_item):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._ast_segment : action_segmentList = _ast_segment
...
class DefineSeg ( ASTNode ,ILPG_item):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._define_segment : defineSpecList = _define_segment
...
class ExportSeg ( ASTNode ,ILPG_item):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._export_segment : terminal_symbolList = _export_segment
...
class GlobalsSeg ( ASTNode ,ILPG_item):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._globals_segment : action_segmentList = _globals_segment
...
class HeadersSeg ( ASTNode ,ILPG_item):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._headers_segment : action_segmentList = _headers_segment
...
class ImportSeg ( ASTNode ,ILPG_item):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._import_segment : import_segment = _import_segment
...
class IncludeSeg ( ASTNode ,ILPG_item):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._include_segment : include_segment = _include_segment
...
class KeywordsSeg ( ASTNode ,ILPG_item):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._keywords_segment : keywordSpecList = _keywords_segment
...
class NamesSeg ( ASTNode ,ILPG_item):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._names_segment : nameSpecList = _names_segment
...
class NoticeSeg ( ASTNode ,ILPG_item):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._notice_segment : action_segmentList = _notice_segment
...
class RulesSeg ( ASTNode ,ILPG_item):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._rules_segment : rules_segment = _rules_segment
...
class StartSeg ( ASTNode ,ILPG_item):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._start_segment : start_symbolList = _start_segment
...
class TerminalsSeg ( ASTNode ,ILPG_item):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._terminals_segment : terminalList = _terminals_segment
...
class TrailersSeg ( ASTNode ,ILPG_item):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._trailers_segment : action_segmentList = _trailers_segment
...
class TypesSeg ( ASTNode ,ILPG_item):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._types_segment : type_declarationsList = _types_segment
...
class RecoverSeg ( ASTNode ,ILPG_item):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._recover_segment : SYMBOLList = _recover_segment
...
class PredecessorSeg ( ASTNode ,ILPG_item):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._predecessor_segment : symbol_pairList = _predecessor_segment
...
class option_specList ( AbstractASTNodeList, Ioptions_segment):
        ...
        def  getoption_specAt(self, i :  int): return  self.getElementAt(i)
        ...
        @staticmethod
        def option_specListfromElement(element,left_recursive : bool )  :
...
class option_spec ( ASTNode ,Ioption_spec):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._option_list : optionList = _option_list
...
class optionList ( AbstractASTNodeList, Ioption_list):
        ...
        def  getoptionAt(self, i :  int): return  self.getElementAt(i)
        ...
        @staticmethod
        def optionListfromElement(element,left_recursive : bool )  :
...
class SYMBOLList ( AbstractASTNodeList, Isymbol_list, Idrop_symbols, IbarSymbolList, Irecover_segment):
        ...
        def  getSYMBOLAt(self, i :  int): return  self.getElementAt(i)
        ...
        @staticmethod
        def SYMBOLListfromElement(element,left_recursive : bool )  :
...
class aliasSpecList ( AbstractASTNodeList, Ialias_segment):
        ...
        def  getaliasSpecAt(self, i :  int): return  self.getElementAt(i)
        ...
        @staticmethod
        def aliasSpecListfromElement(element,left_recursive : bool )  :
...
class alias_lhs_macro_name ( ASTNodeToken ,Ialias_lhs_macro_name):
        ...
        def  getMACRO_NAME(self) -> IToken:  return self.leftIToken 
...
class defineSpecList ( AbstractASTNodeList, Idefine_segment):
        ...
        def  getdefineSpecAt(self, i :  int): return  self.getElementAt(i)
        ...
        @staticmethod
        def defineSpecListfromElement(element,left_recursive : bool )  :
...
class macro_segment ( ASTNodeToken ,Imacro_segment):
        ...
        def  getBLOCK(self) -> IToken:  return self.leftIToken 
...
class terminal_symbolList ( AbstractASTNodeList, Iexport_segment):
        ...
        def  getterminal_symbolAt(self, i :  int): return  self.getElementAt(i)
        ...
        @staticmethod
        def terminal_symbolListfromElement(element,left_recursive : bool )  :
...
class action_segmentList ( AbstractASTNodeList, Iglobals_segment, Inotice_segment, Iaction_segment_list):
        ...
        def  getaction_segmentAt(self, i :  int): return  self.getElementAt(i)
        ...
        @staticmethod
        def action_segmentListfromElement(element,left_recursive : bool )  :
...
class import_segment ( ASTNode ,Iimport_segment):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._SYMBOL : ASTNodeToken = _SYMBOL
            _SYMBOL.setParent(self)
            self._drop_command_list : drop_commandList = _drop_command_list
...
class drop_commandList ( AbstractASTNodeList, Idrop_command_list):
        ...
        def  getdrop_commandAt(self, i :  int): return  self.getElementAt(i)
        ...
        @staticmethod
        def drop_commandListfromElement(element,left_recursive : bool )  :
...
class drop_ruleList ( AbstractASTNodeList, Idrop_rules):
        ...
        def  getdrop_ruleAt(self, i :  int): return  self.getElementAt(i)
        ...
        @staticmethod
        def drop_ruleListfromElement(element,left_recursive : bool )  :
...
class include_segment ( ASTNodeToken ,Iinclude_segment):
        ...
        def  getSYMBOL(self) -> IToken:  return self.leftIToken 
...
class keywordSpecList ( AbstractASTNodeList, Ikeywords_segment):
        ...
        def  getkeywordSpecAt(self, i :  int): return  self.getElementAt(i)
        ...
        @staticmethod
        def keywordSpecListfromElement(element,left_recursive : bool )  :
...
class nameSpecList ( AbstractASTNodeList, Inames_segment):
        ...
        def  getnameSpecAt(self, i :  int): return  self.getElementAt(i)
        ...
        @staticmethod
        def nameSpecListfromElement(element,left_recursive : bool )  :
...
class rules_segment ( ASTNode ,Irules_segment):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._action_segment_list : action_segmentList = _action_segment_list
            _action_segment_list.setParent(self)
            self._nonTermList : nonTermList = _nonTermList
...
class nonTermList ( AbstractASTNodeList, InonTermList):
        ...
        def  getnonTermAt(self, i :  int): return  self.getElementAt(i)
        ...
        @staticmethod
        def nonTermListfromElement(element,left_recursive : bool )  :
...
class RuleName ( ASTNode, IruleNameWithAttributes):
        ...
        def  getSYMBOL(self) -> ASTNodeToken : return self._SYMBOL
        '''/**
         * The value returned by <b>getclassName</b> may be <b>null</b>
         */'''
        def  getclassName(self) -> ASTNodeToken : return self._className
        '''/**
         * The value returned by <b>getarrayElement</b> may be <b>null</b>
         */'''
        def  getarrayElement(self) -> ASTNodeToken : return self._arrayElement
...
class ruleList ( AbstractASTNodeList, IruleList):
        ...
        def  getruleAt(self, i :  int): return  self.getElementAt(i)
        ...
        @staticmethod
        def ruleListfromElement(element,left_recursive : bool )  :
...
class rule ( ASTNode ,Irule):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._symWithAttrsList : symWithAttrsList = _symWithAttrsList
            _symWithAttrsList.setParent(self)
            self._opt_action_segment : action_segment = _opt_action_segment
...
class symWithAttrsList ( AbstractASTNodeList, IsymWithAttrsList):
        ...
        def  getsymWithAttrsAt(self, i :  int): return  self.getElementAt(i)
        ...
        @staticmethod
        def symWithAttrsListfromElement(element,left_recursive : bool )  :
...
class symAttrs ( ASTNode, IoptAttrList):
         ...
         */'''
        def  getMACRO_NAME(self) -> ASTNodeToken : return self._MACRO_NAME
...
class action_segment ( ASTNodeToken ,Iaction_segment):
        ...
        __slots__ = 'environment'
        def __init__(self,environment : LPGParser, token : IToken ):        
            super().__init__(token)
            self.environment = environment
            self.initialize()
...
class start_symbolList ( AbstractASTNodeList, Istart_segment):
        ...
        def  getstart_symbolAt(self, i :  int): return  self.getElementAt(i)
        ...
        @staticmethod
        def start_symbolListfromElement(element,left_recursive : bool )  :
...
class terminalList ( AbstractASTNodeList, Iterminals_segment):
        ...
        def  getterminalAt(self, i :  int): return  self.getElementAt(i)
        ...
        @staticmethod
        def terminalListfromElement(element,left_recursive : bool )  :
...
class type_declarationsList ( AbstractASTNodeList, Itypes_segment):
        ...
        def  gettype_declarationsAt(self, i :  int): return  self.getElementAt(i)
        ...
        @staticmethod
        def type_declarationsListfromElement(element,left_recursive : bool )  :
...
class symbol_pairList ( AbstractASTNodeList, Ipredecessor_segment):
        ...
        def  getsymbol_pairAt(self, i :  int): return  self.getElementAt(i)
        ...
        @staticmethod
        def symbol_pairListfromElement(element,left_recursive : bool )  :
...
class symbol_pair ( ASTNode ,Isymbol_pair):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._SYMBOL : ASTNodeToken = _SYMBOL
            _SYMBOL.setParent(self)
            self._SYMBOL2 : ASTNodeToken = _SYMBOL2
...
class END_KEY_OPT ( ASTNodeToken ,IEND_KEY_OPT):
        ...
        def  getEND_KEY(self) -> IToken:  return self.leftIToken 
...
class option_value1 ( ASTNode ,Ioption_value):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._symbol_list : SYMBOLList = _symbol_list
...
class alias_rhs2 ( ASTNodeToken ,Ialias_rhs):
        ...
        def  getERROR_KEY(self) -> IToken:  return self.leftIToken 
...
class alias_rhs3 ( ASTNodeToken ,Ialias_rhs):
        ...
        def  getEOL_KEY(self) -> IToken:  return self.leftIToken 
...
class alias_rhs4 ( ASTNodeToken ,Ialias_rhs):
        ...
        def  getEOF_KEY(self) -> IToken:  return self.leftIToken 
...
class alias_rhs5 ( ASTNodeToken ,Ialias_rhs):
        ...
        def  getEMPTY_KEY(self) -> IToken:  return self.leftIToken 
...
class alias_rhs6 ( ASTNodeToken ,Ialias_rhs):
        ...
        def  getIDENTIFIER_KEY(self) -> IToken:  return self.leftIToken 
...
class drop_command0 ( ASTNode ,Idrop_command):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._DROPSYMBOLS_KEY : ASTNodeToken = _DROPSYMBOLS_KEY
            _DROPSYMBOLS_KEY.setParent(self)
            self._drop_symbols : SYMBOLList = _drop_symbols
...
class drop_command1 ( ASTNode ,Idrop_command):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._DROPRULES_KEY : ASTNodeToken = _DROPRULES_KEY
            _DROPRULES_KEY.setParent(self)
            self._drop_rules : drop_ruleList = _drop_rules
...
class produces0 ( ASTNodeToken ,Iproduces):
        ...
        def  getEQUIVALENCE(self) -> IToken:  return self.leftIToken 
...
class produces1 ( ASTNodeToken ,Iproduces):
        ...
        def  getPRIORITY_EQUIVALENCE(self) -> IToken:  return self.leftIToken 
...
class produces2 ( ASTNodeToken ,Iproduces):
        ...
        def  getARROW(self) -> IToken:  return self.leftIToken 
...
class produces3 ( ASTNodeToken ,Iproduces):
        ...
        def  getPRIORITY_ARROW(self) -> IToken:  return self.leftIToken 
...
class symWithAttrs1 ( ASTNode ,IsymWithAttrs):
        ...
        def __init__(self, leftIToken : IToken , rightIToken : IToken ,
            ...
            self._SYMBOL : ASTNodeToken = _SYMBOL
            _SYMBOL.setParent(self)
            self._optAttrList : symAttrs = _optAttrList
...
class Visitor (IAstVisitor):
        ...
        __slots__ = ()
        def visit(self, n) -> bool : pass
        def endVisit(self,n) : pass

        def visitASTNodeToken(self, n) -> bool :pass
        def endVisitASTNodeToken(self, n) : pass

        def visitLPG(self, n) -> bool :pass
        def endVisitLPG(self, n) : pass

        def visitLPG_itemList(self, n) -> bool :pass
        def endVisitLPG_itemList(self, n) : pass

        def visitAliasSeg(self, n) -> bool :pass
        def endVisitAliasSeg(self, n) : pass

        def visitAstSeg(self, n) -> bool :pass
        def endVisitAstSeg(self, n) : pass

        def visitDefineSeg(self, n) -> bool :pass
        def endVisitDefineSeg(self, n) : pass

        def visitEofSeg(self, n) -> bool :pass
        def endVisitEofSeg(self, n) : pass

        def visitEolSeg(self, n) -> bool :pass
        def endVisitEolSeg(self, n) : pass

        def visitErrorSeg(self, n) -> bool :pass
        def endVisitErrorSeg(self, n) : pass

        def visitExportSeg(self, n) -> bool :pass
        def endVisitExportSeg(self, n) : pass

        def visitGlobalsSeg(self, n) -> bool :pass
        def endVisitGlobalsSeg(self, n) : pass

        def visitHeadersSeg(self, n) -> bool :pass
        def endVisitHeadersSeg(self, n) : pass

        def visitIdentifierSeg(self, n) -> bool :pass
        def endVisitIdentifierSeg(self, n) : pass

        def visitImportSeg(self, n) -> bool :pass
        def endVisitImportSeg(self, n) : pass

        def visitIncludeSeg(self, n) -> bool :pass
        def endVisitIncludeSeg(self, n) : pass

        def visitKeywordsSeg(self, n) -> bool :pass
        def endVisitKeywordsSeg(self, n) : pass

        def visitNamesSeg(self, n) -> bool :pass
        def endVisitNamesSeg(self, n) : pass

        def visitNoticeSeg(self, n) -> bool :pass
        def endVisitNoticeSeg(self, n) : pass

        def visitRulesSeg(self, n) -> bool :pass
        def endVisitRulesSeg(self, n) : pass

        def visitSoftKeywordsSeg(self, n) -> bool :pass
        def endVisitSoftKeywordsSeg(self, n) : pass

        def visitStartSeg(self, n) -> bool :pass
        def endVisitStartSeg(self, n) : pass

        def visitTerminalsSeg(self, n) -> bool :pass
        def endVisitTerminalsSeg(self, n) : pass

        def visitTrailersSeg(self, n) -> bool :pass
        def endVisitTrailersSeg(self, n) : pass

        def visitTypesSeg(self, n) -> bool :pass
        def endVisitTypesSeg(self, n) : pass

        def visitRecoverSeg(self, n) -> bool :pass
        def endVisitRecoverSeg(self, n) : pass

        def visitPredecessorSeg(self, n) -> bool :pass
        def endVisitPredecessorSeg(self, n) : pass

        def visitoption_specList(self, n) -> bool :pass
        def endVisitoption_specList(self, n) : pass

        def visitoption_spec(self, n) -> bool :pass
        def endVisitoption_spec(self, n) : pass

        def visitoptionList(self, n) -> bool :pass
        def endVisitoptionList(self, n) : pass

        def visitoption(self, n) -> bool :pass
        def endVisitoption(self, n) : pass

        def visitSYMBOLList(self, n) -> bool :pass
        def endVisitSYMBOLList(self, n) : pass

        def visitaliasSpecList(self, n) -> bool :pass
        def endVisitaliasSpecList(self, n) : pass

        def visitalias_lhs_macro_name(self, n) -> bool :pass
        def endVisitalias_lhs_macro_name(self, n) : pass

        def visitdefineSpecList(self, n) -> bool :pass
        def endVisitdefineSpecList(self, n) : pass

        def visitdefineSpec(self, n) -> bool :pass
        def endVisitdefineSpec(self, n) : pass

        def visitmacro_segment(self, n) -> bool :pass
        def endVisitmacro_segment(self, n) : pass

        def visitterminal_symbolList(self, n) -> bool :pass
        def endVisitterminal_symbolList(self, n) : pass

        def visitaction_segmentList(self, n) -> bool :pass
        def endVisitaction_segmentList(self, n) : pass

        def visitimport_segment(self, n) -> bool :pass
        def endVisitimport_segment(self, n) : pass

        def visitdrop_commandList(self, n) -> bool :pass
        def endVisitdrop_commandList(self, n) : pass

        def visitdrop_ruleList(self, n) -> bool :pass
        def endVisitdrop_ruleList(self, n) : pass

        def visitdrop_rule(self, n) -> bool :pass
        def endVisitdrop_rule(self, n) : pass

        def visitoptMacroName(self, n) -> bool :pass
        def endVisitoptMacroName(self, n) : pass

        def visitinclude_segment(self, n) -> bool :pass
        def endVisitinclude_segment(self, n) : pass

        def visitkeywordSpecList(self, n) -> bool :pass
        def endVisitkeywordSpecList(self, n) : pass

        def visitkeywordSpec(self, n) -> bool :pass
        def endVisitkeywordSpec(self, n) : pass

        def visitnameSpecList(self, n) -> bool :pass
        def endVisitnameSpecList(self, n) : pass

        def visitnameSpec(self, n) -> bool :pass
        def endVisitnameSpec(self, n) : pass

        def visitrules_segment(self, n) -> bool :pass
        def endVisitrules_segment(self, n) : pass

        def visitnonTermList(self, n) -> bool :pass
        def endVisitnonTermList(self, n) : pass

        def visitnonTerm(self, n) -> bool :pass
        def endVisitnonTerm(self, n) : pass

        def visitRuleName(self, n) -> bool :pass
        def endVisitRuleName(self, n) : pass

        def visitruleList(self, n) -> bool :pass
        def endVisitruleList(self, n) : pass

        def visitrule(self, n) -> bool :pass
        def endVisitrule(self, n) : pass

        def visitsymWithAttrsList(self, n) -> bool :pass
        def endVisitsymWithAttrsList(self, n) : pass

        def visitsymAttrs(self, n) -> bool :pass
        def endVisitsymAttrs(self, n) : pass

        def visitaction_segment(self, n) -> bool :pass
        def endVisitaction_segment(self, n) : pass

        def visitstart_symbolList(self, n) -> bool :pass
        def endVisitstart_symbolList(self, n) : pass

        def visitterminalList(self, n) -> bool :pass
        def endVisitterminalList(self, n) : pass

        def visitterminal(self, n) -> bool :pass
        def endVisitterminal(self, n) : pass

        def visitoptTerminalAlias(self, n) -> bool :pass
        def endVisitoptTerminalAlias(self, n) : pass

        def visittype_declarationsList(self, n) -> bool :pass
        def endVisittype_declarationsList(self, n) : pass

        def visittype_declarations(self, n) -> bool :pass
        def endVisittype_declarations(self, n) : pass

        def visitsymbol_pairList(self, n) -> bool :pass
        def endVisitsymbol_pairList(self, n) : pass

        def visitsymbol_pair(self, n) -> bool :pass
        def endVisitsymbol_pair(self, n) : pass

        def visitrecover_symbol(self, n) -> bool :pass
        def endVisitrecover_symbol(self, n) : pass

        def visitEND_KEY_OPT(self, n) -> bool :pass
        def endVisitEND_KEY_OPT(self, n) : pass

        def visitoption_value0(self, n) -> bool :pass
        def endVisitoption_value0(self, n) : pass

        def visitoption_value1(self, n) -> bool :pass
        def endVisitoption_value1(self, n) : pass

        def visitaliasSpec0(self, n) -> bool :pass
        def endVisitaliasSpec0(self, n) : pass

        def visitaliasSpec1(self, n) -> bool :pass
        def endVisitaliasSpec1(self, n) : pass

        def visitaliasSpec2(self, n) -> bool :pass
        def endVisitaliasSpec2(self, n) : pass

        def visitaliasSpec3(self, n) -> bool :pass
        def endVisitaliasSpec3(self, n) : pass

        def visitaliasSpec4(self, n) -> bool :pass
        def endVisitaliasSpec4(self, n) : pass

        def visitaliasSpec5(self, n) -> bool :pass
        def endVisitaliasSpec5(self, n) : pass

        def visitalias_rhs0(self, n) -> bool :pass
        def endVisitalias_rhs0(self, n) : pass

        def visitalias_rhs1(self, n) -> bool :pass
        def endVisitalias_rhs1(self, n) : pass

        def visitalias_rhs2(self, n) -> bool :pass
        def endVisitalias_rhs2(self, n) : pass

        def visitalias_rhs3(self, n) -> bool :pass
        def endVisitalias_rhs3(self, n) : pass

        def visitalias_rhs4(self, n) -> bool :pass
        def endVisitalias_rhs4(self, n) : pass

        def visitalias_rhs5(self, n) -> bool :pass
        def endVisitalias_rhs5(self, n) : pass

        def visitalias_rhs6(self, n) -> bool :pass
        def endVisitalias_rhs6(self, n) : pass

        def visitmacro_name_symbol0(self, n) -> bool :pass
        def endVisitmacro_name_symbol0(self, n) : pass

        def visitmacro_name_symbol1(self, n) -> bool :pass
        def endVisitmacro_name_symbol1(self, n) : pass

        def visitdrop_command0(self, n) -> bool :pass
        def endVisitdrop_command0(self, n) : pass

        def visitdrop_command1(self, n) -> bool :pass
        def endVisitdrop_command1(self, n) : pass

        def visitname0(self, n) -> bool :pass
        def endVisitname0(self, n) : pass

        def visitname1(self, n) -> bool :pass
        def endVisitname1(self, n) : pass

        def visitname2(self, n) -> bool :pass
        def endVisitname2(self, n) : pass

        def visitname3(self, n) -> bool :pass
        def endVisitname3(self, n) : pass

        def visitname4(self, n) -> bool :pass
        def endVisitname4(self, n) : pass

        def visitname5(self, n) -> bool :pass
        def endVisitname5(self, n) : pass

        def visitproduces0(self, n) -> bool :pass
        def endVisitproduces0(self, n) : pass

        def visitproduces1(self, n) -> bool :pass
        def endVisitproduces1(self, n) : pass

        def visitproduces2(self, n) -> bool :pass
        def endVisitproduces2(self, n) : pass

        def visitproduces3(self, n) -> bool :pass
        def endVisitproduces3(self, n) : pass

        def visitsymWithAttrs0(self, n) -> bool :pass
        def endVisitsymWithAttrs0(self, n) : pass

        def visitsymWithAttrs1(self, n) -> bool :pass
        def endVisitsymWithAttrs1(self, n) : pass

        def visitstart_symbol0(self, n) -> bool :pass
        def endVisitstart_symbol0(self, n) : pass

        def visitstart_symbol1(self, n) -> bool :pass
        def endVisitstart_symbol1(self, n) : pass

        def visitterminal_symbol0(self, n) -> bool :pass
        def endVisitterminal_symbol0(self, n) : pass

        def visitterminal_symbol1(self, n) -> bool :pass
...
class AbstractVisitor(Visitor):
        ...
        def  unimplementedVisitor(self,s : str) : raise TypeError('Can not instantiate abstract class  with abstract methods')

        def  preVisit(self, element : IAst) -> bool : return True

        def  postVisit(self,element : IAst) : pass

        def visitASTNodeToken(self, n) -> bool :
        ...
        def visitoption_specList(self, n) -> bool :
        ...
        def visitalias_lhs_macro_name(self, n) -> bool :
        ...
        def visitdefineSpecList(self, n) -> bool :
        ...
        def visitterminal_symbolList(self, n) -> bool :
        ...
        def visitaction_segmentList(self, n) -> bool :
        ...
        def visitimport_segment(self, n) -> bool :
        ...
        def visitdrop_commandList(self, n) -> bool :
        ...
        def visitdrop_ruleList(self, n) -> bool :
        ...
        def visitinclude_segment(self, n) -> bool :
        ...
        def visitkeywordSpecList(self, n) -> bool :
        ...
        def visitstart_symbolList(self, n) -> bool :
        ...
        def visitterminalList(self, n) -> bool :
        ...
        def visittype_declarationsList(self, n) -> bool :
        ...
        def visittype_declarations(self, n) -> bool :
        ...
        def visitsymbol_pairList(self, n) -> bool :
        ...
        def visitoption_value1(self, n) -> bool :
        ...
        def visitmacro_name_symbol1(self, n) -> bool :
        ...
        def visitdrop_command0(self, n) -> bool :
        ...
        def visitdrop_command1(self, n) -> bool :
        ...
        def visitsymWithAttrs1(self, n) -> bool :
        ...
        def visitstart_symbol0(self, n) -> bool :
        ...
        def visitstart_symbol1(self, n) -> bool :
        ...
        def visitterminal_symbol0(self, n) -> bool :
        ...
        def visitterminal_symbol1(self, n) -> bool :
