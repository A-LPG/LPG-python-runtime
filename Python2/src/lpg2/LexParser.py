...
class LexParser(object):
    ...
    def reset(self, tokStream, prs, ra):
    ...
    def __init__(self, tokStream=None, prs=None, ra=None):
    ...
    def reallocateStacks(self):
        old_stack_length = (0 if self.stack.__len__() == 0 else self.stackLength)
    ...
    #
    def parseCharacters(self, start_offset, end_offset, monitor):
    ...
    # Parse the input and create a stream of tokens.
    #
    def parseCharactersWhitMonitor(self, monitor=None):
        #
        ...
        while self.current_kind != self.EOFT_SYMBOL:
            ...
            b_continue_process_tokens = False
            # ScanToken:
            while True:
    ...
    #
    def parseNextCharacter(self, token, kind):
        start_action = self.stack[self.stateStackTop]
    ...
    def scanNextToken2(self):
        return self.lexNextToken(self.tokStream.getStreamLength())

    def scanNextToken(self, start_offset=None):
    ...
    def lexNextToken(self, end_offset):
        #
    ...
    # configuration.
    #
    def lexNextCharacter(self, act, kind):
