...
class JavaKWLexerprs(ParseTable,JavaKWLexersym):
    ...
    def isValidForParser(self)  :  return JavaKWLexersym.isValidForParser
    ...
    def isNullable(self, index): return  JavaKWLexerprs._isNullable[index] != 0

    _prosthesesIndex = [0,
            8,7,6,11,9,10,4,12,13,14,
            16,2,3,5,15,1
        ]
    def prosthesesIndex(self, index): return  JavaKWLexerprs._prosthesesIndex[index]
    ...
    def isKeyword(self, index): return  JavaKWLexerprs._isKeyword[index] != 0
    ...
    def baseCheck(self, index): return  JavaKWLexerprs._baseCheck[index]
    _rhs  = _baseCheck
    def rhs(self, index) : return JavaKWLexerprs._rhs[index]
    ...
    def baseAction(self, index): return  JavaKWLexerprs._baseAction[index]
    _lhs  = _baseAction
    def lhs(self, index) : return JavaKWLexerprs._lhs[index]
    ...
    def termCheck(self, index): return  JavaKWLexerprs._termCheck[index]
    ...
    def termAction(self, index): return  JavaKWLexerprs._termAction[index]
